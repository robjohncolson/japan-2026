/*! koko-d3.min.js — vendored D3 force-layout bundle for 「ここどこ?」 (Koko Doko)
 * Concatenated UMD minified builds, loaded locally so the PWA makes NO runtime CDN calls.
 * Packages (attach to window.d3): d3-dispatch 3.0.1, d3-quadtree 3.0.1, d3-timer 3.0.1, d3-force 3.0.0
 * Source: https://cdn.jsdelivr.net/npm/<pkg>@3/dist/<pkg>.min.js
 * License: ISC — Copyright 2010-2021 Mike Bostock (https://github.com/d3). See https://github.com/d3/d3-force/blob/main/LICENSE
 * Load order matters: dispatch, quadtree, timer BEFORE force (force reads window.d3 for its deps).
 */
