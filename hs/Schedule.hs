...
days =
  ...
  , ( "2026-08-01"
    , [ ("cls", "kanzaki")
      , ("label", "→ Mika’s")
      , ("label_ja", "Mika宅へ")
      , ("detail", "<b>~05:00 drive out</b> (Kawasoe Parking: pay at the machine first → flap lowers → out within 3 min; night max ¥500 covers to 08:00) → Kanzaki to meet Mika & Kentaro.<br>Drive rental car Hakata → Kanzaki. Stay at cousin Mika & husband Kentaro’s apartment (nights of 1–2 Aug). No night-game tournament conflict.<br><b>Pitch for the evening: 山茶花の湯 (Sazanka no Yu) with Kentaro</b> — best day-use onsen near Kanzaki, ~15 min via Rte 385 · open-air baths over the Saga plain · ¥830 · 10:00–23:00 · restaurant inside, free parking. If Kentaro has a local favorite, that wins.<br><b>Ramen for any Saga-side day: 来来亭 佐賀新栄店</b> — the rai-rai-tei from last trip (Kyoto-style shoyu · back fat · thin noodles) · 佐賀市新栄東1-4-2 · 11:00–24:00 · ~20–25 min west of Kanzaki.")
      , ("detail_ja", "<b>〜05:00出庫</b>（川添パーキング: 先に精算→3分以内に出庫・夜間最大500円）→ 神埼へ、Mika＆Kentaroと合流。<br>レンタカーで博多→神埼。いとこ Mika と夫 Kentaro のアパートに滞在（8/1〜2 の夜）。ナイトゲーム大会の予定なし。<br><b>夜の提案：Kentaroと山茶花の湯</b>（神埼から約15分・露天から佐賀平野・¥830・10〜23時・食事処あり）。地元のおすすめがあればそちら優先。<br><b>ラーメン（佐賀方面の日に）：来来亭 佐賀新栄店</b>（新栄東1-4-2・11〜24時・車で約20〜25分）。")
      ] )
  , ( "2026-08-02"
    , [ ("cls", "kanzaki")
      , ("label", "Kenji lunch")
